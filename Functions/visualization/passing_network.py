...
config = read_json("Functions/visualization/plot_config.json")
...
def draw_pass_map(ax, player_position,
    ...
    -----------
        ...
        player_position: pandas DataFrame with player names as index and columns 'x' and 'y' in 0-1 range.
    ...
    player_position["x"] = player_position["x"]*height
    player_position["y"] = player_position["y"]*width
